  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Team Grid */}
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 max-w-6xl mx-auto">
          {team.map((member, index) => (
            ...
            >
              <div
                className={`frosted-glass mystic-card rounded-2xl overflow-hidden transition-all duration-500 
                ${
                  hoveredIndex === index
                    ? "translate-y-[-8px] scale-[1.03]"
                    : ""
                }
                ${
